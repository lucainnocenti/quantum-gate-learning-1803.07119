...
def make_reduced_toffoli_model(num_qubits):
    import qubit_network.analytical_conditions as ac

    toffoli_diagonal = ac.commuting_generator(qutip.toffoli(),
                                              interactions='diagonal')
    return toffoli_diagonal
...
def main():
    ...
    # interactions = 'all'
    toffoli_model = make_reduced_toffoli_model(num_qubits)
    # HYPERPARAMETERS
